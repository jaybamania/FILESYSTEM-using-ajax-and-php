...
<body>
	<br><br>
	<div class="container">
		<h2 align="center">Your FileSystem</h2>
		<br>
		<div align="right">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Enter Folder Name
					<input type="text" name="folder_name" id="folder_name" class="form-control"></p><br>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<p>Select Image 
					<input type="file" name="upload_file" /></p><br>
